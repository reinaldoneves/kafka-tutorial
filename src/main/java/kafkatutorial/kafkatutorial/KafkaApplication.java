...
//		TODO: run this cmd at your Kafka partition to consume this topic:
//		$ bin/kafka-console-consumer.sh --topic naldosTopic --from-beginning --bootstrap-server localhost:9092
	}
}
